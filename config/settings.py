...
APPS_DIR = BASE_DIR / "django_with_best_practices"
...
LOCAL_APPS = ["django_with_best_practices.core", "django_with_best_practices.users"]
...
DATABASES = {"default": env.db("DATABASE_URL", default="postgres:///django_with_best_practices")}
...
ACCOUNT_FORMS = {"signup": "django_with_best_practices.users.forms.UserSignupForm"}
